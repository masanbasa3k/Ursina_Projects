...
class Player(Entity):
    def __init__(self, position=(0,4,0)):
        ...
        # Eyes
        self.camera_pivot = Entity(parent=self, y=-0.1)
    ...
    def update(self):
        ...
        self.camera_pivot.rotation_y = (self.rotation_y/100)* time.dt
        self.eye_pivot.rotation_x = self.rotation_x
        self.eye_pivot.rotation_z = -self.rotation_z
